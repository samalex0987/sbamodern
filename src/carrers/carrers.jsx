...
const sampleJobs = [
  {
    ...
    requirements: ["Communication", "New Client Acquisition", "Presentation", "Building client rellationship", "Enterprise sales", "IT Modernization sales", "Solution sales", "Digital Transformation"],
    posted: "2 days ago"
  },
  // {
  //   id: 2,
