...
function Security_and_sustainability(){
    ...
    return(
        ...
        <section class="min-h-screen flex items-center justify-center text-center pt-20 px-4">
            <div>
                <h1 class="text-6xl font-extrabold tracking-tight mb-4 text-white">Security and Sustainability</h1>
                <p class="text-lg mb-6 max-w-xl mx-auto text-white">Secure Enterprise Computing</p>
