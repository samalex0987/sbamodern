...
const ResponsiveNavbar = () => {
  const [display, setDisplay] = useState("Media"); // Renamed Updatedisply to setDisplay for clarity
  ...
  return (
    <>
      {/* Demo Request Popup */}
      {showPopup && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-100 p-4 animate-fadeIn min-h-screen">
          <div className="bg-gray-800 rounded-lg p-6 w-full max-w-md relative animate-scaleIn">
            <button
              onClick={closePopup}
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 bg-gray-700 border border-gray-600 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all duration-200"
                  required
                />
              </div>
              <div>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  rows={3}
                  className="w-full px-4 py-2 bg-gray-700 border border-gray-600 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all duration-200 resize-vertical"
              ...
              <div className="flex gap-4 pt-4">
                <button
                  type="button"
                  onClick={closePopup}
                  className="flex-1 px-4 py-2 border border-gray-600 text-gray-300 rounded-md hover:bg-gray-700 hover:text-white transition-all duration-200"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="flex-1 px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-700 focus:ring-4 focus:ring-red-300 transition-all duration-200"
                >
                  Submit Request
                </button>
              </div>
